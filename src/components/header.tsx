export default function Header() {
  return (
    <header className="site-header fixed top-0 z-50 grid grid-cols-[1fr_auto_1fr] items-center px-5 py-4 sm:px-[4.8vw]">
      <a href="#sobre-mi" className="text-lg font-medium tracking-[-.055em] sm:text-2xl">Claudio<span className="text-[#e85d35]">.dev</span></a>
      <nav aria-label="Navegación principal" className="hidden items-center gap-8 rounded-full bg-white px-9 py-4 text-sm font-medium shadow-[0_10px_22px_rgba(23,32,28,.14)] xl:flex">
        <a href="#sobre-mi" className="transition hover:text-[#e85d35]">Sobre mí</a>
        <a href="#proyectos" className="transition hover:text-[#e85d35]">Proyectos</a>
        <a href="#tecnologias" className="transition hover:text-[#e85d35]">Tecnologías</a>
        <a href="#certificaciones" className="transition hover:text-[#e85d35]">Certificaciones</a>
        <a href="#contacto" className="transition hover:text-[#e85d35]">Contacto</a>
      </nav>
